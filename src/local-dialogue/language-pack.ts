...
import lexiconJson from "./language/ru/lexicon.json" with { type: "json" };
...
export function loadRussianLanguagePack(): LanguagePack {
  ...
  return {
    ...
    fallbacks: readStringMap({ schemaVersion: 1, fallbacks: lexiconJson.fallbacks }, "fallbacks", issues),
    connectors: readStringMap({ schemaVersion: 1, connectors: lexiconJson.connectors }, "connectors", issues),
    vocabulary: readVocabulary({ schemaVersion: 1, vocabulary: lexiconJson.vocabulary }, issues),
    topics: readTopics({ schemaVersion: 1, topics: lexiconJson.topics }, issues),
    issues,
  };
}
