...
const paths: Record<IconName, string> = {
  ...
  together:
    "M8.5 11a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Zm7 1.5a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM2.8 20c.5-4 2.5-6 5.7-6s5.2 2 5.7 6m-1.2-5.1c.7-.3 1.5-.4 2.5-.4 2.8 0 4.6 1.8 5 5.5",
  look: "M4 5h16M7 5c.3 2.4 1.9 3.5 5 3.5S16.7 7.4 17 5l2 15H5z",
  room: "M3 10.5 12 3l9 7.5V21H3zM9 21v-6h6v6",
  settings:
    "M12 8.5A3.5 3.5 0 1 0 12 15.5 3.5 3.5 0 0 0 12 8.5Zm8 3.5 2-1-2-3-2.3.4a8 8 0 0 0-1.1-1.1L17 5l-3-2-1 2a8 8 0 0 0-2 0l-1-2-3 2 .4 2.3a8 8 0 0 0-1.1 1.1L4 8l-2 3 2 1v2l-2 1 2 3 2.3-.4a8 8 0 0 0 1.1 1.1L7 21l3 2 1-2h2l1 2 3-2-.4-2.3a8 8 0 0 0 1.1-1.1L20 18l2-3-2-1z",
  send: "M4 4 21 12 4 20l2.6-6.1L14 12l-7.4-1.9z",
  sparkle: "m12 2 1.5 5.5L19 9l-5.5 1.5L12 16l-1.5-5.5L5 9l5.5-1.5z",
  memory:
    "M8 4.5A3.5 3.5 0 0 0 4.5 8v1A3.5 3.5 0 0 0 3 15.5 3.5 3.5 0 0 0 6.5 19H9V5.5A1.5 1.5 0 0 0 7.5 4Zm8 0A3.5 3.5 0 0 1 19.5 8v1a3.5 3.5 0 0 1 1.5 6.5 3.5 3.5 0 0 1-3.5 3.5H15V5.5A1.5 1.5 0 0 1 16.5 4Z",
